...
console.log('This script populates some test books, authors, genres and bookinstances to your database. Specified database as argument - e.g.: node populatedb "mongodb+srv://ruben:r93AgPCgrKM82xT@cluster0.upt16jm.mongodb.net/local_library?retryWrites=true&w=majority"');
